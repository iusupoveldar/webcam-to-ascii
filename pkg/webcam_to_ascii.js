 ...
 * @param {any} options
 */
export function process_frame(ctx, width, height, image_data, options) {
    const ptr0 = passArray8ToWasm0(image_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.process_frame(ctx, width, height, ptr0, len0, options);
    if (ret[1]) {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_canvas_b73dbfddac9ded86 = function(arg0) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('webcam_to_ascii_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
